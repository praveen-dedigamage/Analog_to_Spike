...
N 720 -610 720 -480 {lab=vdd}
N 720 -950 720 -610 {lab=vdd}
N 550 -950 550 -800 {lab=vdd}
N 470 -600 470 -570 {lab=ibias}
...
C {ipin.sym} 650 -1040 0 0 {name=p24 lab=vdd}
...
C {ipin.sym} 470 -570 0 0 {name=p1 lab=ibias}
